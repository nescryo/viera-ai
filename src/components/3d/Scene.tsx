...
export const Scene: React.FC<SceneProps> = React.memo(({
  ...
  useEffect(() => {
    ...
    // Anime Inverted-Hull Toon Outline Effect (Delicate & fine 0.65mm lineart matching HSR in-game)
    const effect = new OutlineEffect(renderer, {
      defaultThickness: 0.00065, // Ultra-fine & delicate anime lineart
      defaultColor: [0.38, 0.35, 0.40], // Soft slate-lavender matching HSR in-game palette
      defaultAlpha: 0.85,
            ...
            const optimizeMaterial = (mat: THREE.Material): THREE.Material => {
              ...
              if (rawMatName.includes('髪') || rawMatName.includes('頭') || matName.includes('hair')) {
                ...
                hairMat.userData = {
                  outlineParameters: {
                    visible: true,
                    thickness: 0.0006,
                    color: [0.55, 0.50, 0.54], // Soft pastel lavender-ash matching platinum silver hair
                    alpha: 0.80
                  }
                };
              ...
              if (
                ...
                accMat.userData = {
                  outlineParameters: {
                    visible: true,
                    thickness: 0.0006,
                    color: [0.12, 0.36, 0.33], // Dark mint-teal outline for ribbon
                    alpha: 0.85
                  }
                };
              ...
              if (
                ...
                metalMat.userData = {
                  outlineParameters: {
                    visible: true,
                    thickness: 0.00055,
                    color: [0.42, 0.34, 0.26], // Soft warm gold-bronze outline
                    alpha: 0.85
                  }
                };
              ...
              toonMat.userData = {
                outlineParameters: {
                  visible: true,
                  thickness: 0.0007,
                  color: [0.36, 0.33, 0.39], // Soft slate-violet outline for clothes & skirt
                  alpha: 0.82
                }
              };
